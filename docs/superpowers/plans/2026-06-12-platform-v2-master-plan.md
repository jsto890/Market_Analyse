...
| C / WS-3 | WS-3 news/macro | **In progress — slice 3a (news pipeline) done; 3b macro / 3c calendar / 3d morning-report+whale to follow** | [2026-06-16-phase-c-ws3a-news-pipeline.md](2026-06-16-phase-c-ws3a-news-pipeline.md) | 2026-06-16 | Controller: merge `ws3a-news-pipeline`, restart Argus API, confirm `DISCORD_USER_TOKEN` + `DISCORD_NEWS_CHANNEL_ID` in `.env`, bootstrap `com.argus.news-ingest`; 3b needs FinBERT GPU/CPU budget; 3c/3d unblocked |
