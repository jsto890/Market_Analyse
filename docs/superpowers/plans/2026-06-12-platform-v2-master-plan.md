...
| D / WS-5 SP2a | WS-5 0DTE hub — ETF symbol switch (SP2a) | **Starting** — in-process switch across SPY/QQQ/IWM/DIA; upstream changes to OptionsAnalysis then re-vendor; dashboard selector | [plan](2026-06-30-ws5-sp2a-etf-multi-underlying.md) | 2026-07-05 | Executing now. |
